...
- (void)setHeaderCorlor:(double) factor
{
    ...
    if (colors == nil) {
        ...
        UIColor *color = nil;
        color = [UIColor colorWithRed:factor green:0.54*factor blue:0.57*factor alpha:1.0];
        [colors addObject:(id)[color CGColor]];
        color = [UIColor colorWithRed:factor green:0.11*factor blue:0.29*factor alpha:1.0];
        [colors addObject:(id)[color CGColor]];
        color = [UIColor colorWithRed:factor green:0.11*factor blue:0.29*factor alpha:1.0];
        [colors addObject:(id)[color CGColor]];
